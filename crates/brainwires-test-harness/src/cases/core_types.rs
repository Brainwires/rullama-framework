//! Tier-A feature cases for `brainwires-core` types & traits.

use anyhow::Result;
use async_trait::async_trait;
use brainwires_core::{Message, Provider, Role, Usage};
...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::core_types::usage_totals",
        crate_name: "brainwires-core",
...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::core_types::message_constructors",
        crate_name: "brainwires-core",
...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::core_types::provider_trait_roundtrip",
        crate_name: "brainwires-core",
    ...
    async fn run(&self, _trial: usize) -> Result<TrialResult> {
        ...
        let r = p
            .chat(
                &[Message::user("ping")],
                None,
                &brainwires_core::ChatOptions::default(),
            )
            .await?;
