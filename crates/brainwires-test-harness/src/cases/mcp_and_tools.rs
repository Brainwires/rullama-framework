...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::mcp_and_tools::jsonrpc_request_shape",
        crate_name: "brainwires-mcp-client",
...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::mcp_and_tools::tool_input_schema_object",
...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::mcp_and_tools::tool_struct_default",
        crate_name: "brainwires-core",
