...
use brainwires_rag::rag::types::CitedAnswer;
...
inventory::submit! {
    TierACase {
        path: "brainwires_test_harness::cases::rag_cited_answer::RagSearchReturnsTraceableCitations",
        crate_name: "brainwires-rag",
