//! Tier-B adversarial cases for `brainwires_mcp_server::middleware::AuthMiddleware`.
//!
//! Invariants:
...
use brainwires_mcp_server::middleware::auth::AuthMiddleware;
use brainwires_mcp_server::middleware::{Middleware, MiddlewareResult};
use serde_json::json;
...
inventory::submit! {
    SecurityCase {
        ...
        crate_name: "brainwires-mcp-server",
