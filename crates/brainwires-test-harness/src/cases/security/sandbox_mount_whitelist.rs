//! Tier-B adversarial cases for `brainwires_sandbox::SandboxPolicy`.
//!
...
//!
//! Ground truth: `crates/brainwires-sandbox/src/policy.rs`.
...
use brainwires_sandbox::{Mount, NetworkPolicy, SandboxPolicy};
