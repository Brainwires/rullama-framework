...
//!
//! Run: cargo run -p rullama-agent --example saga_compensation
    ...
    if !result3.success {
        ...
        for entry in &report.operations {
            let icon = match entry.status {
                rullama_agent::saga::CompensationOutcome::Success => "OK",
                rullama_agent::saga::CompensationOutcome::Failed => "FAIL",
                rullama_agent::saga::CompensationOutcome::Skipped => "SKIP",
            };
