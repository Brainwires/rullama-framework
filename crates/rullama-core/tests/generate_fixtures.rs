...
//!
//! Run explicitly with:
//!   cargo test -p rullama-core -- --ignored generate_json_fixtures

use rullama_core::message::{ContentBlock, Message, Role, Usage};
use rullama_core::permission::PermissionMode;
use rullama_core::plan::PlanStatus;
use rullama_core::provider::ChatOptions;
use rullama_core::search::SearchResult;
use rullama_core::task::{Task, TaskPriority, TaskStatus};
use rullama_core::tool::{Tool, ToolInputSchema, ToolResult};
use serde::Serialize;
use serde_json::json;
