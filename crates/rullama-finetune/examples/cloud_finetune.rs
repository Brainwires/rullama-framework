...
//!
//! Run: cargo run -p rullama-finetune --example cloud_finetune --features cloud

use rullama_finetune::{
...
async fn main() {
    ...
    let demo_job_id: rullama_finetune::TrainingJobId = "ftjob-demo-000".into();
