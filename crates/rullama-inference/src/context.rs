...
use rullama_core::WorkingSet;
use rullama_tool_runtime::{ToolExecutor, ToolPreHook};
...
pub struct AgentContext {
    ...
    /// [`PreHookDecision::Reject`](rullama_tool_runtime::PreHookDecision::Reject) causes the tool call to be skipped and
