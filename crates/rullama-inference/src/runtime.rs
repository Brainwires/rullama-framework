...
//! use rullama_agent::{CommunicationHub, FileLockManager};
//!
//! struct MyAgent { /* ... */ }
//!
...
use rullama_core::{ChatResponse, Message, ToolResult, ToolUse};
...
use rullama_agent::file_locks::{FileLockManager, LockType};
...
mod tests {
    use super::*;
    use rullama_core::{ContentBlock, Message, MessageContent, Role, Usage};
