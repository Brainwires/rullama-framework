...
//! ```rust,ignore
//! use std::sync::Arc;
//! use rullama_agent::summarization::{LlmSummarizer, Summarizer};
//!
...
//! with any `rullama_core::Provider` — typically pointed at a cheaper
...
fn render_transcript(messages: &[Message]) -> String {
    use rullama_core::{ContentBlock, MessageContent, Role};
