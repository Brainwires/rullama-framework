...
//! ```rust,ignore
//! use std::sync::Arc;
//! use rullama_agent::{AgentContext, TaskAgent, TaskAgentConfig, TaskAgentResult};
...
#[derive(Clone)]
pub struct BillingHookRef(pub std::sync::Arc<dyn rullama_telemetry::BillingHook>);
...
#[cfg(feature = "telemetry")]
impl BillingHookRef {
    /// Wrap a [`BillingHook`](rullama_telemetry::BillingHook) implementation.
    pub fn new(hook: impl rullama_telemetry::BillingHook) -> Self {
