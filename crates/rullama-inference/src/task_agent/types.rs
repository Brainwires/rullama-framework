...
use rullama_agent::execution_graph::{ExecutionGraph, RunTelemetry};
...
pub struct TaskAgentResult {
    ...
    pub pre_execution_plan: Option<rullama_core::SerializablePlan>,
}
...
pub struct TaskAgentConfig {
    ...
    pub plan_budget: Option<rullama_core::PlanBudget>,
    ...
    ///
    /// When `Some`, emits [`rullama_telemetry::AnalyticsEvent::AgentRun`] after
    ...
    ///
    /// When `Some`, emits a [`rullama_telemetry::UsageEvent`] at every
