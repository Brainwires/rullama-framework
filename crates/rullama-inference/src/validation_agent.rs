...
use rullama_agent::resource_checker::{ConflictCheck, ResourceChecker};
use rullama_agent::state_model::{StateModelProposedOperation, StateSnapshot, ThreeStateModel};
...
impl ValidationAgent {
    ...
    pub async fn check_resource_conflicts(
        &self,
        operation: &rullama_agent::resource_checker::ProposedOperation,
    ) -> ConflictCheck {
...
mod tests {
    ...
    use rullama_agent::resource_locks::ResourceLockManager;
