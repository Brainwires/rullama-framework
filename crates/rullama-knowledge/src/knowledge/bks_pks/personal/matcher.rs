...
mod tests {
    ...
    fn test_get_relevant_facts() {
        ...
        let facts = [
            ...
            create_test_fact(PersonalFactCategory::Context, "project", "rullama"),
        ];
    ...
    fn test_extract_keywords() {
        let keywords = extract_keywords("I am working on a Rust project called rullama");

        assert!(keywords.contains("working"));
        assert!(keywords.contains("rust"));
        assert!(keywords.contains("project"));
        assert!(keywords.contains("rullama"));
