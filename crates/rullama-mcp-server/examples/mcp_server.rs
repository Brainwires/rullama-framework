...
//!
//! ```bash
//! cargo run -p rullama-network --example mcp_server --features server
//! ```

use anyhow::Result;
use async_trait::async_trait;
use rullama_mcp_client::{CallToolResult, ServerCapabilities, ServerInfo};
...
#[async_trait]
impl rullama_mcp_server::McpHandler for DemoHandler {
