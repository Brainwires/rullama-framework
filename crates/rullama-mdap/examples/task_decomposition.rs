...
//!
//! Run with: `cargo run -p rullama-agent --features mdap --example task_decomposition`

use rullama_mdap::decomposition::{DecomposeContext, SequentialDecomposer, TaskDecomposer};
use rullama_mdap::scaling::{ModelCosts, estimate_mdap};
