...
use rullama_storage::databases::{LanceDatabase, StorageBackend};
...
// are defined locally below — they live in rullama-stores::tier_types
...
// FactType — moved to rullama-stores::tier_types (used by both the
