...
//!
//! ```rust,ignore
//! use rullama::permissions::audit::{AuditLogger, AuditEvent, AuditEventType};
//!
...
impl rullama_telemetry::anomaly::ObservedEvent for AuditEvent {
    ...
    fn category(&self) -> rullama_telemetry::anomaly::EventCategory {
        use rullama_telemetry::anomaly::EventCategory;
...
pub struct AuditLogger {
    ...
    anomaly_detector: Option<rullama_telemetry::anomaly::AnomalyDetector>,
}

impl AuditLogger {
    /// Create a new audit logger with the default path (~/.rullama/audit/)
    #[cfg(feature = "native")]
    ...
    pub fn with_anomaly_detection(
        mut self,
        config: rullama_telemetry::anomaly::AnomalyConfig,
    ) -> Self {
        self.anomaly_detector = Some(rullama_telemetry::anomaly::AnomalyDetector::new(config));
        self
    }
    ...
    pub fn drain_anomalies(&self) -> Option<Vec<rullama_telemetry::anomaly::AnomalyEvent>> {
...
mod tests {
    ...
    fn test_logger_with_anomaly_detection_violation() {
        use rullama_telemetry::anomaly::AnomalyConfig;
        use tempfile::TempDir;
