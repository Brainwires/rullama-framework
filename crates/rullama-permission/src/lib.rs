...
//! - **Configuration**: TOML-based configuration via ~/.rullama/permissions.toml
...
// Anomaly detection lives in `rullama-telemetry::anomaly`. Depend on
// rullama-telemetry directly:
//   use rullama_telemetry::anomaly::{AnomalyConfig, AnomalyDetector, ...};
