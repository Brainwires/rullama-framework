...
[![Crates.io](https://img.shields.io/crates/v/rullama-provider-speech.svg)](https://crates.io/crates/rullama-provider-speech)
...
[`rullama-provider`](https://crates.io/crates/rullama-provider).
...
```rust,ignore
use rullama_provider_speech::ElevenLabsClient;
...
- [`rullama-hardware`](https://crates.io/crates/rullama-hardware) —
