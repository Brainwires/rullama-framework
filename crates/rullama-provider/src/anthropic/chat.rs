...
/// the `Provider` trait from `rullama_core`.
...
impl AnthropicChatProvider {
    ...
    pub fn cache_prompt_enabled(strategy: rullama_core::CacheStrategy) -> bool {
        !matches!(strategy, rullama_core::CacheStrategy::Off)
    }
...
mod tests {
    ...
    fn test_cache_prompt_enabled_maps_strategy() {
        use rullama_core::CacheStrategy;
