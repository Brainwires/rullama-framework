...
impl AnthropicClient {
    ...
    fn build_body(&self, req: &AnthropicRequest, streaming: bool) -> serde_json::Value {
        ...
        let strategy = if matches!(&self.auth_strategy, AuthStrategy::Anthropic { .. }) {
            ...
            rullama_core::provider::CacheStrategy::Off
        };
        use rullama_core::provider::CacheStrategy;
...
pub struct AnthropicRequest {
    ...
    #[serde(skip)]
    pub cache_strategy: rullama_core::provider::CacheStrategy,
}
...
mod tests {
    ...
    fn test_anthropic_request_serialization() {
        let req = AnthropicRequest {
            ...
            tools: None,
            stream: false,
            cache_strategy: rullama_core::CacheStrategy::Off,
        };
    ...
    fn test_build_body_system_cache_control_when_enabled() {
        ...
        let req = AnthropicRequest {
            ...
            tools: None,
            stream: false,
            cache_strategy: rullama_core::CacheStrategy::SystemAndTools,
        };
        let body = client.build_body(&req, false);
