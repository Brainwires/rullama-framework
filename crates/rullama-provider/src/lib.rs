...
//! them with the `rullama_core::Provider` trait.

// Re-export core traits for convenience
pub use rullama_core::provider::{ChatOptions, Provider};
...
// Browser-native `web_speech` lives in `rullama-provider-speech`.
...
// Audio/speech client re-exports live on `rullama-provider-speech`.
