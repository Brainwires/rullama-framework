//! Conversion helpers between rullama-core types and Responses API types.
...
/// Convert rullama-core messages to Responses API input items.
///
...
/// Convert rullama-core tools to Responses API tool definitions.
...
/// Parse a full ResponseObject into a rullama-core ChatResponse.
...
/// Convert ResponseUsage to rullama-core Usage.
