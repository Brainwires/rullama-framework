...
//! By default it indexes the rullama-knowledge crate itself.
//!
//! Run:
//! ```sh
//! cargo run -p rullama-knowledge --example rag_search --features rag
//! ```

use rullama_rag::rag::client::RagClient;
use rullama_rag::rag::types::{IndexRequest, QueryRequest};
