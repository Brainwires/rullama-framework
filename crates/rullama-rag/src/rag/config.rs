/// Configuration system for rullama-rag
///
...
fn default_lancedb_path() -> PathBuf {
    rullama_core::paths::PlatformPaths::default_lancedb_path()
}
...
fn default_hash_cache_path() -> PathBuf {
    rullama_core::paths::PlatformPaths::default_hash_cache_path()
}

fn default_git_cache_path() -> PathBuf {
    rullama_core::paths::PlatformPaths::default_git_cache_path()
}
...
impl Config {
    ...
    pub fn load_or_default() -> Result<Self, RagError> {
        let config_path = rullama_core::paths::PlatformPaths::default_config_path();
