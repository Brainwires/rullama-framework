...
//!
//! ## Scope note — `prompting` stays in `rullama-knowledge`
//!
...
//! to `bks_pks` inside `rullama-knowledge` and a move would have pulled
...
// ── Parsers (moved from rullama-core) ─────────────────────────────────
...
// ── Scorers (moved from rullama-agent::reasoning) ────────────────────
mod complexity;
mod entity_enhancer;
