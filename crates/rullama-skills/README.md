...
[![Crates.io](https://img.shields.io/crates/v/rullama-skills.svg)](https://crates.io/crates/rullama-skills)
...
`rullama-agent`, then re-extracted in 0.11 (Phase 11c) once the
...
```toml
# Before
rullama-agent = { features = ["skills-registry"] }

# After
rullama-skills = { features = ["registry"] }
```

```rust
// Before
use rullama_agent::skills::{SkillRegistry, SkillRouter};

// After
use rullama_skills::{SkillRegistry, SkillRouter};
```
