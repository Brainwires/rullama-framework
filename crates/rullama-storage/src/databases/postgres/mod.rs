...
//! * The `postgres-backend` Cargo feature enabled on `rullama-storage`.
//!
//! # Example
//!
//! ```rust,no_run
...
const DEFAULT_URL: &str = "postgresql://localhost:5432/rullama";
...
impl PostgresDatabase {
    ...
    ///
    /// Connects to `DEFAULT_URL` (`postgresql://localhost:5432/rullama`)
...
mod tests {
    ...
    fn test_default_url() {
        assert_eq!(
            ...
            "postgresql://localhost:5432/rullama"
        );
    }
}
