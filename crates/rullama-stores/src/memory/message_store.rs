...
pub struct MessageMetadata {
    ...
    /// `TieredMemory::evict_expired` (in `rullama-memory`) for tier-aware cleanup.
...
pub struct MessageStore<B: StorageBackend = rullama_storage::databases::lance::LanceDatabase> {
    backend: Arc<B>,
