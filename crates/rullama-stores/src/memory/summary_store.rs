...
//!
//! Uses a [`rullama_storage::StorageBackend`] for persistence with semantic search capability.
...
pub struct SummaryStore<B: StorageBackend = rullama_storage::databases::lance::LanceDatabase> {
    backend: Arc<B>,
