...
//!
//! Plans are stored via a [`rullama_storage::databases::StorageBackend`] for querying and linked to conversations.
...
use rullama_core::{PlanMetadata, PlanStatus};
...
pub struct PlanStore<B: StorageBackend = rullama_storage::databases::lance::LanceDatabase> {
    backend: Arc<B>,
