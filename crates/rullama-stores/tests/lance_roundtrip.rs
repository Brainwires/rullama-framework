...
//! `rullama-stores`. Exercises the CRUD path through the public API
...
//! `cargo test -p rullama-stores --features
...
use rullama_core::plan::{PlanMetadata, PlanStatus};
...
use rullama_storage::embeddings::CachedEmbeddingProvider;
use rullama_storage::image_types::ImageFormat;
use rullama_stores::{
