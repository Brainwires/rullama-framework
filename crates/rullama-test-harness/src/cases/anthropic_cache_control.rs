...
use rullama_provider::AnthropicClient;
...
fn build_body_for(strategy: CacheStrategy, large_history: bool) -> Result<Value> {
    use rullama_provider::anthropic::{
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::anthropic_cache_control::AnthropicCacheControlEmittedPerStrategy",
        crate_name: "rullama-provider",
