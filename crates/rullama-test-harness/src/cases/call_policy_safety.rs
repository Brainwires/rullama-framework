//! Tier-A feature cases for `rullama-call-policy` (FEATURES.md "Safety").

use anyhow::Result;
use async_trait::async_trait;
use rullama_call_policy::{BudgetConfig, BudgetGuard};
use rullama_core::Usage;
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::call_policy_safety::budget_guard_caps_record_check_reset",
