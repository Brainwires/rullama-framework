//! Tier-A feature cases for `rullama-eval`'s own primitives.
//!
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::evaluation_framework::always_pass",
        crate_name: "rullama-eval",
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::evaluation_framework::stochastic_deterministic",
        crate_name: "rullama-eval",
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::evaluation_framework::wilson_ci",
        crate_name: "rullama-eval",
