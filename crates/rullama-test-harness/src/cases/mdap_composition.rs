//! Tier-A feature cases for `rullama-mdap` composition.

use anyhow::Result;
use async_trait::async_trait;
use rullama_eval::{EvaluationCase, TrialResult};
use rullama_mdap::Composer;
use rullama_mdap::decomposition::CompositionFunction;
use rullama_mdap::microagent::SubtaskOutput;
use serde_json::json;
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::mdap_composition::identity_lastonly_concatenate",
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::mdap_composition::empty_results_errors",
        crate_name: "rullama-mdap",
