//! Tier-A feature cases for `rullama-permission` capability profiles.
...
inventory::submit! {
    TierACase {
        path: "rullama_test_harness::cases::permission_capabilities::default_and_full_have_expected_shape",
