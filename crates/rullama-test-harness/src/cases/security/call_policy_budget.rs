//! Tier-B adversarial cases for `rullama_call_policy::BudgetProvider`
...
use rullama_test_fixtures::{FailingProvider, ScriptedProvider};
...
impl EvaluationCase for BudgetPrecheckBlocksProviderCase {
    ...
    async fn run(&self, _trial: usize) -> Result<TrialResult> {
        ...
        guard.record_usage(&rullama_core::Usage::new(60, 60));
...
impl EvaluationCase for BudgetUnboundedDefaultCase {
    ...
    async fn run(&self, _trial: usize) -> Result<TrialResult> {
        ...
        guard.record_usage(&rullama_core::Usage::new(1_000_000, 1_000_000));
