//! Tier-B adversarial cases for `rullama_provider_speech::RateLimiter`.
//!
...
use rullama_provider_speech::rate_limiter::RateLimiter;
...
inventory::submit! {
    SecurityCase {
        ...
        crate_name: "rullama-provider-speech",
