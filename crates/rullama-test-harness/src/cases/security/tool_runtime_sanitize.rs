//! Tier-B adversarial cases for `rullama_tool_runtime::sanitize_external_content`
...
use rullama_tool_runtime::{sanitize_external_content, wrap_with_content_source};
...
inventory::submit! {
    SecurityCase {
        ...
        crate_name: "rullama-tool-runtime",
