...
use rullama_tool_runtime::{ToolExecutor, ToolRegistry, ToolSearchTool};
    ...
    async fn dispatch(
        ...
        #[cfg(feature = "native")]
        {
            match tool_name {
                ...
                "check_duplicates" | "verify_build" | "check_syntax" => {
                    return rullama_tool_runtime::ValidationTool::execute(
                        tool_use_id,
                        tool_name,
                        input,
                        context,
        ...
        #[cfg(any(feature = "orchestrator", feature = "orchestrator-wasm"))]
        {
            if tool_name == "execute_script" {
                let orchestrator = rullama_tool_runtime::OrchestratorTool::new();
                return orchestrator
