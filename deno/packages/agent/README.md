...
Agent orchestration, coordination, and lifecycle management for the rullama.
Provides the core agentic execution loop, task agents, inter-agent
communication, and distributed coordination patterns.
