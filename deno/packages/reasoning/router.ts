 ...
 *
 * Categories match the strings used by `@rullama/tool-runtime`'s
 * `ToolCategory`. Consumers can remap them to their own taxonomy.
 *
...
/** Tool category tag — same labels as `@rullama/tool-runtime`'s ToolCategory. */
