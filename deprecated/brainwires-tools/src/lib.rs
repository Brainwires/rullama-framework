#![deprecated(
    since = "0.10.1",
    note = "split into `brainwires-tool-runtime` (executor + registry + framework) and `brainwires-tool-builtins` (concrete bash / file_ops / git / web / search / code_exec / browser / email / calendar / system tools). The 0.10.0 façade was removed in 0.11 to break the implicit coupling. Migrate per the README at https://github.com/Brainwires/rullama-framework/tree/main/deprecated/brainwires-tools"
)]
