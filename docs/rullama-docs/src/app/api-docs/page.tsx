...
function hasLocalRustdoc(): boolean {
  try {
    return fs.existsSync(path.join(process.cwd(), "public", "rustdoc", "rullama", "index.html"));
  } catch { return false; }
}
    ...
    <div className="px-6 py-8 max-w-[1400px] mx-auto w-full">
      ...
      {hasLocal ? (
        <>
          ...
          <iframe src="/rustdoc/rullama/index.html" className="w-full rounded-lg border"
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed py-20 text-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="https://docs.rs/rullama" target="_blank" rel="noopener noreferrer"
              ...
              docs.rs/rullama <ExternalLink className="size-3.5" />
            </a>
            <a href="https://crates.io/crates/rullama" target="_blank" rel="noopener noreferrer"
