...
pub struct Pipelines {
    ...
    pub adaln_modulate: wgpu::ComputePipeline,
    pub rope_interleaved: wgpu::ComputePipeline,
    pub conv2d_chw_f32: wgpu::ComputePipeline,
    pub upsample2x_chw: wgpu::ComputePipeline,
    pub gated_residual_add: wgpu::ComputePipeline,
...
impl Pipelines {
    ...
    pub fn new(device: &wgpu::Device) -> Self {
        Self {
            ...
            adaln_modulate: build(device, "adaln_modulate", kernels::ADALN_MODULATE),
            rope_interleaved: build(device, "rope_interleaved", kernels::ROPE_INTERLEAVED),
            conv2d_chw_f32: build(device, "conv2d_chw_f32", kernels::CONV2D_CHW_F32),
            upsample2x_chw: build(device, "upsample2x_chw", kernels::UPSAMPLE2X_CHW),
            gated_residual_add: build(device, "gated_residual_add", kernels::GATED_RESIDUAL_ADD),
