// Batched MulmatID Q5_0 expert matmul (DiffusionGemma canvas). Position/slot
// indexing == moe_expert_matmul_batched_q8_0.wgsl; Q5_0 dequant == above.
// slice_blocks = (k/32)*n.
