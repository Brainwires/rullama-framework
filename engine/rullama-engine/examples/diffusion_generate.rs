...
//!
//!   cargo run -p rullama-engine --release --example diffusion_generate -- \
...
use rullama_engine::diffusion::DiffusionGemma;
use rullama_engine::gguf::{FileFetcher, TensorFetcher};
use rullama_engine::reference::diffusion::sampler::{EbParams, StepInfo};
