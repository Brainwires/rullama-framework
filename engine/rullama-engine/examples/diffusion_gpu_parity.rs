...
//!
//!   cargo run -p rullama-engine --release --example diffusion_gpu_parity -- \
...
use rullama_engine::backend::{BindGroupCache, Pipelines, WeightCache, WgpuCtx};
use rullama_engine::gguf::{FileFetcher, GgufReader};
use rullama_engine::reference::Weights;
use rullama_engine::reference::diffusion::DiffusionConfig;
use rullama_engine::reference::diffusion::forward::diffusion_forward;
use rullama_engine::reference::diffusion::gpu::diffusion_forward_gpu;
