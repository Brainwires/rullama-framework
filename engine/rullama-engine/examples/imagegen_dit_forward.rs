...
//!
//! Usage:
//!   cargo run -p rullama-engine --release --example imagegen_dit_forward -- \
...
use rullama_engine::imagegen::{ShardedSafetensors, TransformerConfig};
use rullama_engine::reference::dit::DitForward;
