...
//!
//! Usage:
//!   cargo run -p rullama-engine --release --example imagegen_generate -- \
...
use rullama_engine::imagegen::{Qwen3Config, ShardedSafetensors, TransformerConfig, VaeConfig};
use rullama_engine::reference::pipeline::{Components, generate};
