...
use rullama_engine::reference::forward_chained::{GlobalLoraSlots, LayerLoraSlots, LoraSlot};
use rullama_lora::load_adapter_into_state;
use rullama_lora::lora::{LoraKey, LoraLayer, LoraState};
...
fn allocate_lora_slots(
    ...
    // allocator in `rullama-lora::session::build_lora_state`.
