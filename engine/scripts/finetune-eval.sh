...
#
# Default jsonl: rullama-lora/examples/data/garlic-best-food.jsonl
...
GGUF="${1:-}"
JSONL="${2:-rullama-lora/examples/data/garlic-best-food.jsonl}"
...
# rullama-engine/src/sampling.rs:109-119 — divides positive logits for
