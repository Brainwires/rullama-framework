//! WebSocket client for the brainwires-gateway — mirror of the one in
//! `mcp-google-chat`, specialised for this channel type.
...
mod tests {
    ...
    fn handshake_fields() {
        ...
        assert_eq!(hs.channel_type, "nextcloud_talk");
