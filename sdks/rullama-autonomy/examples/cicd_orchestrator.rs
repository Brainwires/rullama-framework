...
use rullama_autonomy::config::{CommandConfig, WebhookConfig, WebhookRepoConfig};
use rullama_autonomy::git_workflow::{
...
fn main() {
    ...
    let issue_ctx = InterpolationContext::for_issue("rullama-cli", 42, "Fix auth bug");
    ...
    let push_ctx = InterpolationContext::for_push("rullama-cli", "refs/tags/v1.2.3", "abc123");
    ...
    let branch_ctx = InterpolationContext::for_push("rullama-cli", "main", "def456");
    ...
    let tempdir = std::env::temp_dir().join("rullama-example-webhook-logs");
    ...
    let events = vec![
        WebhookEvent {
            ...
            repo: "Brainwires/rullama-cli".to_string(),
            git_ref: String::new(),
