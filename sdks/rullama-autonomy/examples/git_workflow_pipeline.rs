...
use rullama_autonomy::config::GitWorkflowConfig;
...
async fn main() -> anyhow::Result<()> {
    ...
    let issue = Issue {
        ...
        url: "https://github.com/Brainwires/rullama-cli/issues/42".to_string(),
    };
    println!(
        "  Issue #{}: {} (by {})",
    ...
    let events: Vec<WorkflowEvent> = vec![
        ...
        WorkflowEvent::IssueCommented {
            ...
            comment: Comment {
                ...
                body: "@rullama fix this please".to_string(),
            },
            repo: repo.clone(),
        },
    ...
    let pr = PullRequest {
        ...
        url: "https://github.com/Brainwires/rullama-cli/pull/100".to_string(),
        state: PrState::Open,
    };
