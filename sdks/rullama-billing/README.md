...
- **`SqliteLedger`** *(feature `sqlite`)* — WAL-mode SQLite at `~/.rullama/billing/billing.db`
...
```rust
use rullama_billing_impl::{AgentWallet, SqliteLedger};
use rullama_agent::task_agent::{BillingHookRef, TaskAgentConfig};
use std::sync::Arc;
