...
fn show_version_info() {
    println!("rullama-brain v{}", env!("CARGO_PKG_VERSION"));
    println!();
    ...
    println!();
    println!("Storage:");
    println!("  Thoughts:        LanceDB (embedded, ~/.rullama/brain/)");
    println!("  PKS:             SQLite  (personal facts, ~/.rullama/pks.db)");
    println!("  BKS:             SQLite  (behavioral truths, ~/.rullama/bks.db)");
    println!();
