...
pub struct IssueStore<B: StorageBackend + 'static = rullama_storage::LanceDatabase> {
    backend: Arc<B>,
...
pub struct CommentStore<B: StorageBackend + 'static = rullama_storage::LanceDatabase> {
    backend: Arc<B>,
}
...
mod tests {
    use super::*;
    use rullama_storage::{FieldDef, FieldValue, Filter, Record, ScoredRecord, StorageBackend};
