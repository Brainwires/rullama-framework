...
fn show_version_info() {
    // Basic version info
    println!("rullama-rag v{}", env!("CARGO_PKG_VERSION"));
    println!();
    ...
    {
        use rullama_storage::databases::LanceDatabase;
    ...
    {
        use rullama_storage::databases::QdrantDatabase;
